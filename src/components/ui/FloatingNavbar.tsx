            ...
            {isVisible && (
                <div className="fixed top-0 left-0 right-0 z-50 flex justify-center py-3 px-3 md:px-6">
                    <motion.nav
                        ...
                        className="container max-w-7xl mx-auto bg-white/90 dark:bg-black/90 backdrop-blur-xl border border-gray-200/50 dark:border-gray-800/50 shadow-lg shadow-gray-200/20 dark:shadow-black/40 rounded-2xl"
                    >
                                ...
                                <div className="flex items-center gap-3">
                                    <div className="relative group">
                                        ...
                                        <img
                                            src={logo}
                                            alt={`${title} Icon`}
                                            className="relative h-9 w-9 rounded-xl object-cover flex-shrink-0 border border-gray-200/50 dark:border-white/10"
                                        />
                                    </div>
